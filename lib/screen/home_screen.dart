      ...
      drawer: Drawer(
        child: ListView(
          children: [
            ...
            SizedBox(height: 50,),
            ListTile(onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (context) => OnlyExpense(),)),leading: Icon(Icons.attach_money,color: Colors.indigoAccent,),title: Text("Expense"),trailing: Icon(Icons.keyboard_arrow_right),),
            Divider(),
            ...
            Divider(),
            ListTile(onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (context) => GoalsScreenon(),)),leading: Icon(Icons.sports_soccer,color: Colors.indigoAccent,),title: Text("Goals"),trailing: Icon(Icons.keyboard_arrow_right),),
            Divider(),
            ...
            ListTile(onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (context) =>PdfPage() ,)),leading: Icon(Icons.menu_book,color: Colors.indigoAccent,),title: Text("Print Out statement"),trailing: Icon(Icons.keyboard_arrow_right),),
            Divider(),
            ...
            ListTile(onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (context) =>LoansDepth() ,)),leading: Icon(Icons.menu_book,color: Colors.indigoAccent,),title: Text("Print Out Loans and Depth"),trailing: Icon(Icons.keyboard_arrow_right),),
            Divider(),
